...
$db = mysqli_connect("localhost","root","","meridukaan"); 
...
function total_price()	{ // getting total price from the added cart 
...
function getCatPro() {
			...
			if(isset ($_GET['cat'])){
					...
					if($count==0){
						...
						echo "<h2>No Product is Available in this category!</h2>";
...
function getBrandPro() {
			...
			if(isset ($_GET['brand'])){
					...
					$get_brand_pro = "select * from products where cat_id='$brand_id'";
					...
					if($count==0){
						...
						echo "<h2>No Product is Available in this brand!</h2>";
